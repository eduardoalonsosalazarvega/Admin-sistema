...
source "./certificados.sh"  # Asegúrate de que las funciones SSL están en este archivo
...
while true; do
    ...
    if [ "$op" -eq 1 ]; then
        ...
        echo "Selecciona la versión que desea instalar: "
        ...
        echo "Opción no válida. Vuelve a intentar."
    fi
done
